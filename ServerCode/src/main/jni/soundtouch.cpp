...
#include "SensorServer_utility_SoundTouch.h"
 ...
 */
extern "C" DLL_PUBLIC jstring Java_SensorServer_utility_SoundTouch_getVersionString(JNIEnv *env, jclass thiz)
{
    const char *verStr;
 ...
 * Signature: ()J
 */
extern "C" DLL_PUBLIC jlong Java_SensorServer_utility_SoundTouch_newInstance(JNIEnv *env, jclass thiz)
{
 ...
 * Signature: (J)V
 */
extern "C" DLL_PUBLIC void Java_SensorServer_utility_SoundTouch_deleteInstance(JNIEnv *env, jobject thiz, jlong handle)
{
 ...
 * Signature: (JF)V
 */
extern "C" DLL_PUBLIC void Java_SensorServer_utility_SoundTouch_setTempo(JNIEnv *env, jobject thiz, jlong handle, jfloat tempo)
{
	SoundTouch *ptr = (SoundTouch*)handle;
	ptr->setTempo(tempo);
}
 ...
 * Signature: (JF)V
 */
extern "C" DLL_PUBLIC void Java_SensorServer_utility_SoundTouch_setPitchSemiTones(JNIEnv *env, jobject thiz, jlong handle, jfloat pitch)
{
	SoundTouch *ptr = (SoundTouch*)handle;
 ...
 * Signature: (JF)V
 */
extern "C" DLL_PUBLIC void Java_SensorServer_utility_SoundTouch_setSpeed(JNIEnv *env, jobject thiz, jlong handle, jfloat speed)
{
	SoundTouch *ptr = (SoundTouch*)handle;
	ptr->setRate(speed);
}
 ...
 * Signature: ()Ljava/lang/String;
 */
extern "C" DLL_PUBLIC jstring Java_SensorServer_utility_SoundTouch_getErrorString(JNIEnv *env, jclass thiz)
{
 ...
 */
extern "C" DLL_PUBLIC int Java_SensorServer_utility_SoundTouch_processFile(JNIEnv *env, jobject thiz, jlong handle, jstring jinputFile, jstring joutputFile)
{
	SoundTouch *ptr = (SoundTouch*)handle;
 ...
 */
extern "C" DLL_PUBLIC jfloat Java_SensorServer_utility_SoundTouch_getMyBPM(JNIEnv* env,jclass thiz, jstring inFileName )
{
